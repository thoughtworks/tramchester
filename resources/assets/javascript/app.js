...
var techLabApp = angular.module('techLabApp', ['ngResource']).
                 config(function ($routeProvider, $locationProvider){
                    $routeProvider.when('/routePlanner', {templateUrl: 'templates/RoutePlanner.html', controller: 'RoutePlannerController'}).
                    when('/advancedRoutePlanner', {templateUrl: 'templates/AdvancedRoutePlanner.html', controller: 'AdvancedRoutePlannerController'}).
                    ...
                    when('/journeyDetails/:journeyIndex', {templateUrl: 'templates/JourneyDetails.html', controller: 'JourneyDetailsController'})//.
