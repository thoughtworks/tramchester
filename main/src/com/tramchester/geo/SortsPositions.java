...
public class SortsPositions {
    ...
    public <T> List<T> sortedByNearTo(List<String> destinationStationIds, List<HasStationId<T>> hasStationIds) {
        ...
        hasStationIds.forEach(item -> sorted.add(Pair.of(item.getContained(),
