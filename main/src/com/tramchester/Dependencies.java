...
import com.tramchester.graph.build.IncludeAllFilter;
import com.tramchester.graph.build.StagedTransportGraphBuilder;
...
public class Dependencies {
    ...
    public void initialise(TramchesterConfig configuration) throws IOException {
        ...
        picoContainer.addComponent(TransportDataFromFileFactory.class);
