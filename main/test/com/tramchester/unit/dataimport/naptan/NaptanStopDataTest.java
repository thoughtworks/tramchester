...
import static com.tramchester.repository.naptan.NaptanStopType.*;
import static org.junit.jupiter.api.Assertions.assertEquals;

class NaptanStopDataTest extends ParserTestHelper<NaptanStopData> {

    @BeforeEach
    void beforeEach() {
        super.before(NaptanStopData.class, "\"ATCOCode\",\"NaptanCode\",\"PlateCode\",\"CleardownCode\",\"CommonName\",\"" +
    ...
    void shouldParseData() {
        NaptanStopData data = super.parse("\"9400ZZMAWWD2\",\"mantwgdp\",\"\",\"\",\"Westwood (Manchester Metrolink)\",\"\",\"\",\"\",\"\",\"\",\"" +
    ...
    void shouldParseForBusStationWithIndicator() {
        NaptanStopData data = super.parse("\"2800S16001B\",\"mergjtpm\",\"\",\"\",\"St Helens Bus Station\",\"en\",\"St Helens Bus St 2\",\"en\",\"" +
