...
class CompositeStationRepositoryTest {
    ...
    void shouldHaveCorrectNumberOfComposites() {
        ...
        assertEquals(duplicateNamesFromFullRepository, repository.getNumberOfComposites());
        assertEquals(duplicateNamesFromFullRepository, repository.getCompositesFor(Bus).size());
    }
